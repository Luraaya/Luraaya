...
const getTranslations = () => {
  return {
    ...
    de: {
      ...
      "privacy.section1.1.body": "Verantwortlich für die Bearbeitung von Personendaten im Sinne des Schweizerischen Datenschutzgesetzes (DSG) ist: Luraaya, Hilfikerstrasse 4, 3014 Bern, Schweiz, E-Mail: luraaya@outlook.com. Nachfolgend wird Luraaya als „wir“, „uns“ oder „unser Angebot“ bezeichnet. Diese Datenschutzerklärung erläutert, wie wir Personendaten im Zusammenhang mit unserer Website, unserer Applikation und unseren digitalen Dienstleistungen bearbeiten.",
    ...
    fr: {
      ...
      "privacy.section7.1.body": "Nous faisons notamment appel aux prestataires suivants : hébergement et déploiement (Vercel, Hostpoint), gestion des versions (GitHub), base de données et backend (Supabase), traitement des paiements (Stripe), communication et messagerie (Twilio), ainsi que traitement basé sur l’intelligence artificielle (API GPT). Ces prestataires traitent les données personnelles exclusivement dans le cadre de leur fonction respective. Toute utilisation indépendante à leurs propres fins est exclue. Des accords de traitement des données sont conclus ou préparés lorsque cela est requis.",
